        ...
        <div className="space-y-2">
          ...
          >
            ...
            <option value="PARTICULAR">PARTICULAR</option>
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-100">SARS-CoV-2 (PCR)</label>
                  <select
                    name="sarsCov2"
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-100">Chagas</label>
                  <select
                    name="chagas"
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-100">Toxoplasmosis</label>
                  <select
                    name="toxoplasmosis"
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-100">HIV</label>
                  <select
                    name="hiv"
                    value={paciente.hiv}
                    onChange={handleChange}
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-100">VDRL</label>
                  <select
                    name="vdrl"
                    value={paciente.vdrl}
                    onChange={handleChange}
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-100">Hepatitis B</label>
                  <select
                    name="hepatitisB"
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-100">EGB</label>
                  <select
                    name="egb"
                    value={paciente.egb}
                    onChange={handleChange}
